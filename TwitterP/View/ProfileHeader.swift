...
class ProfileHeader: UICollectionReusableView {
    ...
    private lazy var containerView: UIView = {
        ...
        backButton.anchor(top: view.topAnchor, left: view.leftAnchor, paddingTop: 40, paddingLeft: 16)
    ...
    private let bioLabel: UILabel = {
        ...
        label.text = "This is a user bio that will span mote than one line for test purposes"
        return label
    }()
